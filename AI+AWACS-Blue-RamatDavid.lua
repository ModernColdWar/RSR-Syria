...
TEXACOTankerBlue2 = SPAWN
  ...
  :InitLimit(1,3)
--  :InitCleanUp(30)
  :OnSpawnGroup(function(SpawnedGroup)MESSAGE:New("TEXACO Blue 2-1 is back on station",25,"TEXACO Blue 2-1"):ToBlue()end)
...
SHELLTankerBlue2 = SPAWN
  ...
  :InitLimit(1,3)
  :InitCleanUp(30)
  :OnSpawnGroup(function(SpawnedGroup)MESSAGE:New("SHELL Blue 2-1 is back on station",25,"SHELL Blue 2-1"):ToBlue()end)
  :SpawnScheduled(3600,0.1) 
