...
TEXACOTankerRed2 = SPAWN
  ...
  :InitLimit(1,3)
  --:InitCleanUp(30)
  :OnSpawnGroup(function(SpawnedGroup)MESSAGE:New("TEXACO Red 2-1 is back on station",25,"TEXACO Red 2-1"):ToRed()end)
...
SHELLTankerRed2 = SPAWN
  ...
  :InitLimit(1,3)
  --:InitCleanUp(30)
  :OnSpawnGroup(function(SpawnedGroup)MESSAGE:New("SHELL Red 2-1 is back on station",25,"SHELL Red 2-1"):ToRed()end)
  :SpawnScheduled(3600,0.1) 
