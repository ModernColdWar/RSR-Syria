...
function BlueAWACs(group,rng)
  ...
  local spawnUnit = Spawn_Blue_AWACs:SpawnFromVec2(spawnVec2)
end
...
function BlueTankerBasket(group,rng)
  ...
  local spawnPt = pos:Translate(range, hdg, true)
  local spawnVec2 = spawnPt:GetVec2() 
  local spawnUnit = Spawn_Blue_TankerBasket:SpawnFromVec2(spawnVec2)
end
...
function BlueTankerBoom(group,rng)
  ...
  local spawnPt = pos:Translate(range, hdg, true)
  local spawnVec2 = spawnPt:GetVec2() 
  local spawnUnit = Spawn_Blue_TankerBoom:SpawnFromVec2(spawnVec2)
end
...
function BlueTankerRecovery(group,rng)
  ...
  local spawnPt = pos:Translate(range, hdg, true)
  local spawnVec2 = spawnPt:GetVec2() 
  local spawnUnit = Spawn_Blue_TankerRecovery:SpawnFromVec2(spawnVec2)
end
...
function RedAWACs(group,rng)
  ...
  local spawnPt = pos:Translate(range, hdg, true)
  local spawnVec2 = spawnPt:GetVec2() 
  local spawnUnit = Spawn_Red_AWACs:SpawnFromVec2(spawnVec2)
end
...
function RedTankerBasket(group,rng)
  ...
  local spawnPt = pos:Translate(range, hdg, true)
  local spawnVec2 = spawnPt:GetVec2() 
  local spawnUnit = Spawn_Red_TankerBasket:SpawnFromVec2(spawnVec2)
end
...
function RedTankerBoom(group,rng)
  ...
  local spawnPt = pos:Translate(range, hdg, true)
  local spawnVec2 = spawnPt:GetVec2() 
  local spawnUnit = Spawn_Red_TankerBoom:SpawnFromVec2(spawnVec2)
end
...
local function AWACs_Tanker_MENU()
  SetClient3:ForEachClient(function(client3)
      ...
      local groupName = group3:GetName()
            ...
            ---- Sub Menu
            BlueSpawnAWACsmenu = MENU_GROUP:New( BlueMenuGroup2, "AWACs-Tankers Menu", BlueSpawnAWACs)
            ---- Command for the sub Menu the number on the end is the argument for the command (the rng) for the function
            BlueSpawnAWACsrng5 = MENU_GROUP_COMMAND:New( BlueMenuGroup2, "Spawn E-3", BlueSpawnAWACs, BlueAWACs, BlueMenuGroup2, 5)
            ...
            BlueSpawnTanker1rng5 = MENU_GROUP_COMMAND:New( BlueMenuGroup2, "Spawn KC-135MPRS", BlueSpawnAWACs, BlueTankerBasket, BlueMenuGroup2, 5)
            ...
            BlueSpawnTanker2rng5 = MENU_GROUP_COMMAND:New( BlueMenuGroup2, "Spawn KC-135", BlueSpawnAWACs, BlueTankerBoom, BlueMenuGroup2, 5)
            ...
            BlueSpawnTanker3rng5 = MENU_GROUP_COMMAND:New( BlueMenuGroup2, "Spawn S-3 Tanker", BlueSpawnAWACs, BlueTankerRecovery, BlueMenuGroup2, 5)
...
local function AWACs_Tanker_MENU2()
  SetClient4:ForEachClient(function(client4)
      ...
      local groupName = group4:GetName()
            ...
            ---- Command for the sub Menu the number on the end is the argument for the command (the rng) for the function
            RedSpawnAWACsrng5 = MENU_GROUP_COMMAND:New( RedMenuGroup2, "Spawn E-3", RedSpawnAWACs, RedAWACs, RedMenuGroup2, 5)
            RedRemainingAWACs = MENU_GROUP_COMMAND:New( RedMenuGroup2, "Remaining AWACs", RedSpawnAWACs, RemainingRedAWACS, RedMenuGroup2)
            RedSpawnTanker1rng5 = MENU_GROUP_COMMAND:New( RedMenuGroup2, "Spawn KC-135MPRS", RedSpawnAWACs, RedTankerBasket, RedMenuGroup2, 5)
            ...
            RedSpawnTanker2rng5 = MENU_GROUP_COMMAND:New( RedMenuGroup2, "Spawn KC-135", RedSpawnAWACs, RedTankerBoom, RedMenuGroup2, 5)
